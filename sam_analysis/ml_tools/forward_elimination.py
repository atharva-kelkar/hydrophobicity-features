...
This script contains script to run forward elimination for feature selection
...
##############################################################################
## FORWARD ELIMINATION CLASS
class ForwardElimination:
    """class object used to perform forward elimination"""
    def __init__( self,
                  regressor,
                  k_features = 10,
                  floating   = False,
...
#        regressor = LinearRegression()
        ...
        ## INITIALIZE FORWARD ELIMINATION CLASS
        forward_elim = ForwardElimination( regressor,
                                         k_features = 10,
                                         floating   = True,
                                         scoring    = "neg_mean_squared_error",
                                         n_jobs     = 1, )
        ## COMPUTE
        results = forward_elim.compute( X_train = X_train,
                                        y_train = y_train,
                                        X_test  = X_val,
                                        y_test  = y_val, )
